...
const SwipeLink = ({ children, onSwipeLeft, onSwipeRight, allowSwipe = true }: SwipeLinkProps) => {
  ...
  return (
    <div className="relative w-full max-w-md mx-auto h-[500px]" ref={constraintsRef}>
      {/* Swipe direction indicators - making them more visible */}
      {allowSwipe && (
        <>
          <div className="absolute left-[-70px] top-1/2 transform -translate-y-1/2 text-sm font-medium text-gray-600 rotate-[-90deg] bg-gray-100 px-3 py-1 rounded-full shadow-sm">
            Swipe left to reject
          </div>
          <div className="absolute right-[-70px] top-1/2 transform -translate-y-1/2 text-sm font-medium text-gray-600 rotate-90 bg-gray-100 px-3 py-1 rounded-full shadow-sm">
